...
const Home = () => {
  ...
  const coverMessage =
    " A Symphony of Words In every curve, a tale unfolds, like whispers of the ancients in inked gold. The dance of letters, a poets dream, where beauty and meaning eternally gleam. A timeless art, where silence speaks, and hearts find solace the soul seeks..".split(
      " "
    );
